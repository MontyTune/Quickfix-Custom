...
class IOI(Message):
	...
	class NoSecurityAltID(fix.Group):
		def __init__(self):
			...
			order[1] = 456
			order[2] = 0
			fix.Group.__init__(self, 454, 10455, order)
	...
	class NoUnderlyings(fix.Group):
		...
		class NoUnderlyingSecurityAltID(fix.Group):
			def __init__(self):
				...
				order[1] = 459
				order[2] = 0
				fix.Group.__init__(self, 457, 10456, order)
...
class PositionReport(Message):
	...
	class NoLinks(fix.Group):
		def __init__(self):
			order = fix.IntArray(3)
			order[0] = 16113
			order[1] = 16114
			order[2] = 0
			fix.Group.__init__(self, 16112, 16113, order)
...
class RequestForPosition(Message):
	def __init__(self):
		Message.__init__(self)
		self.getHeader().setField( fix.MsgType("UAN") )

class GatewayStatusRequest(Message):
	def __init__(self):
		Message.__init__(self)
		self.getHeader().setField( fix.MsgType("UAR") )

class GatewayStatus(Message):
	def __init__(self):
		Message.__init__(self)
		self.getHeader().setField( fix.MsgType("UAT") )

	class NoGatewayStatus(fix.Group):
		def __init__(self):
			order = fix.IntArray(6)
			order[0] = 18202
			order[1] = 207
			...
			order[4] = 58
			order[5] = 0
			fix.Group.__init__(self, 18201, 18202, order)
